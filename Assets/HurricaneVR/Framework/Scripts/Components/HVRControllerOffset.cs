...
namespace HurricaneVR.Framework.Components
{
    public class HVRControllerOffset : MonoBehaviour
    {
        ...
        private HVRInputSettings _inputSettings;

        public Vector3 ControllerPositionOffset => _inputSettings != null ? _inputSettings.ControllerPositionOffset : Vector3.zero;
        public Vector3 ControllerRotationOffset => _inputSettings != null ? _inputSettings.ControllerRotationOffset : Vector3.zero;
        ...
        private void ControllerConnected(HVRController controller)
        {
            ...
            {
                _inputSettings = controller.InputMap;
            }
